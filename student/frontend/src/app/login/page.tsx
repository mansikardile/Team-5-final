...
function StudentLoginForm() {
  ...
  const triggerGoogleLogin = useGoogleLogin({
    ...
    onError: () => {
      setServerError('Google authorization popup was closed.');
      setIsGoogleLoading(false);
...
export default function StudentLoginPage() {
  return (
    <Suspense fallback={<div className="p-12 text-center text-xs font-bold text-slate-400">Loading sign in...</div>}>
      <StudentLoginForm />
    </Suspense>
  );
}
